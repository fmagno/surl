...
@session_router.get("")
async def use(
    # session: SessionDb = Depends(get_or_create),
    *,
    # request: Request,
...
# @session_router.post("/create_session/{name}")
...
# @session_router.get("/whoami", dependencies=[Depends(cookie)])
# async def whoami(session_data: SessionData = Depends(verifier)):
#     return session_data


# @session_router.post("/delete_session")
